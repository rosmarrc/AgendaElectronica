    ...
    public partial class Form1 : Form
    {
        ...
        private void btnInsertar_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrWhiteSpace(nombre) || string.IsNullOrWhiteSpace(apellido) || string.IsNullOrWhiteSpace(direccion) ||
                string.IsNullOrWhiteSpace(genero) || string.IsNullOrWhiteSpace(estadoCivil) || string.IsNullOrWhiteSpace(movil) ||
                string.IsNullOrWhiteSpace(telefono) || string.IsNullOrWhiteSpace(correoElectronico))
            {
                MessageBox.Show("Por favor, complete todos los campos antes de insertar el registro.");
                return;
            }
